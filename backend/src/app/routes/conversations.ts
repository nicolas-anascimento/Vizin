...
router.get("/:id/messages",c.getConversationMessages);router.post("/:id/messages",rateLimit({windowMs:60_000,max:30,scope:"chat-message"}),c.sendConversationMessage);
