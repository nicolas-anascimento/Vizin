...
/* ============================================================
   ...
   GET /api/objetos/:id
   Resposta esperada:
   { id, titulo, categoria, imagem, proprietario: { nome } }
   (opcionalmente, confirme também que o pagamento foi aprovado
   via GET /api/pedidos/:id antes de liberar esta tela)
   ============================================================ */
let produto = null;
...
async function carregarProduto() {
    try {
        ...
        document.getElementById("produto-mini-proprietario").textContent = produto.proprietario.nome || produto.proprietario;
 
    } catch (err) {
        console.error(err);
        alert("Não foi possível carregar os dados do objeto.");
    }
}
...
/* ============================================================
   PONTO DE INTEGRAÇÃO COM O BACK-END
   POST /api/retiradas (multipart/form-data)
   campos: objeto_id, observacoes, fotos[]
   ============================================================ */
