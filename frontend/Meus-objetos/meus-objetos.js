...
async function carregarMeusObjetos() {
    /* ============================================================
       ...
       Espera-se um retorno JSON: array de objetos no formato usado
       abaixo em renderizarMeusObjetos (id, titulo, descricao,
       categoria, preco_dia, disponivel, imagem, localizacao).
       ============================================================ */
    try {
        ...
        if (!response.ok) {
            throw new Error(`Erro ${response.status} ao carregar objetos`);
        }
        ...
        console.error(err);
        mostrarToast("Não foi possível carregar seus objetos", "erro");
